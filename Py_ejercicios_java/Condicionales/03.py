...
if((examen1<0 or examen1>10) or (examen2<0 or examen2>10) or (examen3<0 or examen3>10)):
    ...
    nota_final = float(examen1*porcentaje_examen1)/100 + (examen2*porcentaje_examen2)/100 + (examen3*porcentaje_examen3)/100
    print(f'La nota final es {nota_final}')


if (nota_final < 5):
    print(f'Suspenso con un {nota_final}')
elif (nota_final < 6):
    print(f'Suficiente con un {nota_final}')
elif (nota_final < 7):
    print(f'Bien con un {nota_final}')
elif (nota_final < 8):
    print(f'Notable bajo con un {nota_final}')
elif (nota_final < 9):
    print(f'Notable alto con un {nota_final}')
elif (nota_final < 10):
    print(f'Sobresaliente con un {nota_final}')
elif(nota_final == 10):
    print(f'Matricula de honor con un {nota_final}')